...
package com.github.snail.auth.feign;

import com.github.snail.auth.feign.fallback.UserServiceFallbackImpl;
...
@FeignClient(name = "snail-upms-service", fallback = UserServiceFallbackImpl.class)
