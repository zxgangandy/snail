...
package com.github.snail.admin.common.util;
...
public class ResourcesGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://139.224.200.249:3309/snail?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setSuperControllerClass("com.github.snail.common.web.BaseController");
        // 表名生成策略
        ...
        pc.setParent("com.github.snail.admin");
